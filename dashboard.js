...
const ctx = document.getElementById('foundedByYearChart').getContext("2d");
  ...
  const ct =document.getElementById("numberOfinvestors").getContext("2d");
      ...
      new Chart(ct,{
        type:"pie",
        data: {
          labels: ["Tiger Global Management", "Accel", "Insight Partners", "D1 Capital Partners", "SoftBank Vision Fund", "IndiaQuotient", "unitus ventures", "omidyar network india", "Lightspeed Venture Partners", "Goldman Sachs", "Ant Financial", "Warburg Pincus", "Sequoia Capital", "Temasek Holdings", "ADIA", "DST Global", "Google", "Walmart", "Facebook"],
          datasets: [{
            label: 'Investor Invested in companies',
            data: [29, 6, 7, 1, 14, 1, 1, 1,  5, 1, 2, 1, 18, 1,  1, 3, 1, 1, 1],
            borderWidth: 1
          }],
          options: {
            scales: {
